// This page is independent of your portfolio details.
export const businessCard = {
  name: 'Rufat Niftaliyev',
  title: 'Full-Stack Software Developer',
  organization: 'DAC UTSA',
  avatar: '/avatar.jpg',
  avatarAlt: 'Rufat Niftaliyev',
  banner: '/banner.jpg',
  bannerAlt: 'San Antonio skyline at dusk',
  // Leave blank to encode this page's current URL in the QR code.
  publicUrl: '',
  accent: '#5265a8',
  contacts: [
